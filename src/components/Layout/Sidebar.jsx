...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 w-64 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-700/50 flex flex-col transition-all duration-300 z-20 md:hidden ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
