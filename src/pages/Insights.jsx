  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white/70 dark:bg-gray-800/60 backdrop-blur-md rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(170,59,255,0.05)] p-6 border border-white/20 dark:border-gray-700/50">
          ...
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">
            ₹{insights.avgDailyExpense.toFixed(2)}
          </p>
        </div>
        <div className="bg-white/70 dark:bg-gray-800/60 backdrop-blur-md rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(170,59,255,0.05)] p-6 border border-white/20 dark:border-gray-700/50">
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
          ...
          <p
            className={`text-2xl font-bold ${insights.savingRate >= 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
          >
        ...
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                contentStyle={
                  isDarkMode ? darkTooltipStyle : customTooltipStyle
                }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        ...
        <div className="flex flex-col h-full w-full bg-white/70 dark:bg-gray-800/60 backdrop-blur-md rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(170,59,255,0.05)] p-6 border border-white/20 dark:border-gray-700/50">
